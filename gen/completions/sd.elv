...
set edit:completion:arg-completer[sd] = {|@words|
    ...
    var completions = [
        &'sd'= {
            ...
            cand -L 'Process input line by line instead of reading the entire input at once. This reduces memory usage and enables streaming for stdin, but prevents patterns from matching across line boundaries'
            cand --line-by-line 'Process input line by line instead of reading the entire input at once. This reduces memory usage and enables streaming for stdin, but prevents patterns from matching across line boundaries'
