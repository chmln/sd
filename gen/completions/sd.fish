...
complete -c sd -s L -l line-by-line -d 'Process input line by line instead of reading the entire input at once. This reduces memory usage and enables streaming for stdin, but prevents patterns from matching across line boundaries'
